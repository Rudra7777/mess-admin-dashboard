...
export default function Sidebar({ isOpen, onClose }) {
    ...
    return (
        <>
            ...
            <aside
                className={`fixed top-0 left-0 h-full bg-white border-r border-border z-50 transition-transform duration-200 ease-in-out w-64
          ${isOpen ? "translate-x-0" : "-translate-x-full"}`}
            >
                ...
                <div className="h-16 flex items-center justify-between px-6 border-b border-border">
                    ...
                    <button
                        onClick={onClose}
                        className="p-1 rounded-md text-text-secondary hover:text-text-primary hover:bg-gray-100 cursor-pointer"
                    >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
